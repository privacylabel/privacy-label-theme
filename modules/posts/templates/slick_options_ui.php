...
<div class="mw-flex-row slider-options">
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Pager", "templates/privacy-label"); ?></label>
            <select name="pager" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pager == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($pager == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Controls", "templates/privacy-label"); ?></label>
            <select name="controls" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($controls == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($controls == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Loop", "templates/privacy-label"); ?></label>
            <select name="loop" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($loop == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($loop == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Adaptive Height", "templates/privacy-label"); ?></label>
            <select name="adaptive_height" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($adaptiveHeight == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($adaptiveHeight == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Autoplay Speed" , "templates/privacy-label"); ?></label>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Pause on hover", "templates/privacy-label"); ?></label>
            <select name="pause_on_hover" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pauseOnHover == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($pauseOnHover == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Autoplay", "templates/privacy-label"); ?></label>
            <select name="autoplay" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($autoplay == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($autoplay == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Draggable", "templates/privacy-label"); ?></label>
            <select name="draggable" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($draggable == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($draggable == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Fade", "templates/privacy-label"); ?>
            ...
            <select name="fade" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($fade == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($fade == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Focus On Select", "templates/privacy-label"); ?></label>
            <select name="focus_on_select" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($focusOnSelect == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/privacy-label"); ?></option>
                <option value="true" <?php if ($focusOnSelect == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/privacy-label"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Center Padding", "templates/privacy-label"); ?></label>
