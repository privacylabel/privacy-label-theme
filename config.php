...
$config = array();
$config['name'] = "Privacy Label";
$config['author'] = "Tijmen Schep";
$config['version'] = 2.9;
$config['url'] = "https://www.privacylabel.org";
...
$config['stylesheet_compiler']['settings']['fontFamily'] = array('type' => 'font_selector', 'default' => 'inter', 'label' => 'Choose font for your site');
$config['stylesheet_compiler']['settings']['fontFamily']['options'] = array('lato' => 'Inter');
